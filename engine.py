...
from helpers import adjust_keep_rate, adjust_distillation_alpha
...
def train_one_epoch(model: torch.nn.Module, criterion: DistillationLoss,
    ...
    # Adjust distillation alpha for adaptive distillation
    if hasattr(criterion, 'set_alpha'):
        current_alpha = adjust_distillation_alpha(
            epoch=epoch,
            warmup_epochs=0,  # not used in adjust_distillation_alpha
            shrink_start_epoch=args.shrink_start_epoch,
            shrink_epochs=args.shrink_epochs,
            alpha_start=args.distillation_alpha_start,
            alpha_end=args.distillation_alpha_end,
