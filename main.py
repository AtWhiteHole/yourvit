...
def get_args_parser():
    ...
    parser.add_argument('--distillation-type', default='none',
                        choices=['none', 'soft', 'hard', 'soft_hard', 'adaptive_soft_hard'],
                        type=str, help="Type of distillation")
    parser.add_argument('--distillation-alpha', default=0.5, type=float,
                        help="Distillation weight (for fixed distillation)")
    parser.add_argument('--distillation-alpha-start', default=0.1, type=float,
                        help="Starting distillation weight (for adaptive distillation)")
    parser.add_argument('--distillation-alpha-end', default=0.5, type=float,
                        help="Ending distillation weight (for adaptive distillation)")
    parser.add_argument('--distillation-tau', default=1.0, type=float, help="Temperature for soft distillation")
